...
taiwan_school=read.csv("C:/Users/USER/OneDrive - The University of Sydney (Students)/Desktop/R Transportation/R Github Project/Spatial-Analysis/data/taiwan_school/taiwan_school.csv", fileEncoding="Big5")
